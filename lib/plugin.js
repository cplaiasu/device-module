...
function extractDevices (ctx, userAgent = DEFAULT_USER_AGENT) {
  ...
  linux = isLinux(userAgent)

  return { mobile, mobileOrTablet, ios, android, windows, macOS, linux }
}
...
export default async function (ctx, inject) {
  ...
  const { mobile, mobileOrTablet, ios, android, windows, macOS, linux } = extractDevices(ctx, userAgent)
